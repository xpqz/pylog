...
function updateLoadingProgress(step, message) {
    ...
    if (!progressContainer) {
        ...
        const steps = [
            ...
            { id: 'loading-release', text: 'Loading PyLog release assets' },
            { id: 'release-loaded', text: 'Release information loaded' },
            { id: 'installing-lark', text: 'Installing Lark parser (GitHub release)' },
