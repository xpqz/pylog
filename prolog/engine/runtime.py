...
class Trail:
    ...
    def __init__(self):
        ...
        self._var_stamps: Dict[Tuple[str, int], int] = (
            {}
        )  # (kind, varid) -> last trail stamp
    ...
    def push_parent(
        self, varid: int, old_parent: int, stamp: Optional[int] = None
    ) -> None:
    ...
    def push_attr(
        self, varid: int, module: str, old_value: Any, stamp: Optional[int] = None
    ) -> None:
    ...
    def push_domain(
        self, varid: int, old_domain: Any, stamp: Optional[int] = None
    ) -> None:
