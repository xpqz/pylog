...
class Engine:
    ...
    def _register_builtins(self):
        ...
        # Dynamic database predicates - now registered via builtins.dynamic_db module
    ...
    def run(
        ...
        while True:
            ...
            if self.max_steps is not None or self._deadline is not None:
                ...
                if self._deadline is not None and not self._steps_taken & 0x3FF:
    ...
    # --- Helpers (dynamic DB) - These are now thin wrappers for compatibility ---
    # The actual implementations are in builtins/dynamic_db.py
