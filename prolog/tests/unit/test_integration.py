...
from prolog.tests.helpers import mk_fact, mk_rule, program, assert_no_recursion
...
class TestComplexBacktracking:
    ...
    def test_cut_in_first_clause(self):
        ...
        prog = program(
            mk_rule(
                "test", (Var(0, "X"),), Struct("p", (Var(0, "X"),)), Atom("!")
            ),  # Cut here
    ...
    def test_nested_cuts(self):
        ...
        prog = program(
            ...
            mk_rule("outer", (Var(0, "X"),), Struct("inner", (Var(0, "X"),))),
...
class TestResourceManagement:
    ...
    def test_max_solutions_no_resource_leak(self):
        ...
        prog = program(
            ...
            mk_rule("infinite", (Var(0, "X"),), Struct("infinite", (Var(0, "X"),))),
        )
    ...
    def test_call_backtracking_purity(self):
        ...
        prog = program(
            ...
            mk_fact("p", Atom("2")),
            mk_rule(
                "test", (Var(0, "X"),), Struct("call", (Struct("p", (Var(0, "X"),)),))
            ),
        )
...
class TestMixedClauseOrdering:
    ...
    def test_fact_rule_fact_ordering(self):
        ...
        prog = program(
            ...
            mk_rule("mixed", (Var(0, "X"),), Struct("helper", (Var(0, "X"),))),
            # Another fact
    ...
    def test_interleaved_facts_and_rules(self):
        ...
        prog = program(
            ...
            mk_rule("complex", (Atom("b"), Var(0, "Y")), Struct("gen", (Var(0, "Y"),))),
            mk_fact("complex", Atom("c"), Atom("2")),
            mk_rule(
                "complex", (Atom("d"), Var(0, "Y")), Struct("gen2", (Var(0, "Y"),))
            ),
            # Generators
            mk_fact("gen", Atom("g1")),
            mk_fact("gen", Atom("g2")),
...
class TestBuiltinInteraction:
    ...
    def test_call_with_cut(self):
        ...
        prog = program(
            mk_rule("test", (Atom("a"),), Struct("call", (Atom("!"),))),
            mk_fact("test", Atom("b")),
        )
    ...
    def test_call_undefined_predicate_fails(self):
        ...
        prog = program(
            mk_rule("test", (), Struct("call", (Struct("nonexistent", ()),)))
        )
    ...
    def test_call_with_non_callable_fails(self):
        ...
        prog = program(
            ...
            mk_rule("test_int", (), Struct("call", (Int(123),))),
            # Try to call a list
            mk_rule("test_list", (), Struct("call", (List((Atom("a"), Atom("b"))),))),
        )
    ...
    def test_builtin_fail_precedence(self):
        ...
        prog = program(
            ...
            mk_rule("test", (), Atom("fail"), Struct("never_reached", ())),
        )
    ...
    def test_builtin_true_precedence(self):
        ...
        prog = program(
            ...
            mk_rule("test", (), Atom("true"), Struct("reached", ())),
            mk_fact("reached"),
        )
